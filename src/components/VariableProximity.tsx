...
function useMousePositionRef(
  ...
  useEffect(() => {
    const getTargetRect = () => {
      const target = containerRef?.current ?? fallbackRef.current;
...
const VariableProximity = forwardRef<HTMLSpanElement, VariableProximityProps>((props, ref) => {
  ...
  const mousePositionRef = useMousePositionRef(containerRef, rootRef as MutableRefObject<HTMLElement | null>);
  ...
  useAnimationFrame(() => {
    const measurementRoot = containerRef?.current ?? rootRef.current;
    ...
    const containerRect = measurementRoot.getBoundingClientRect();
